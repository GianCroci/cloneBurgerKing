...
export const Delivery = () => {
  ...
  const seleccionEnvio = () => {
    botonPeyaRef.current.classList.add("border-4");
    botonPeyaRef.current.classList.add("border-red-700");
    botonRappiRef.current.classList.remove("border-red-700");
    botonRappiRef.current.classList.remove("border-4");
  ...
  const seleccionEnvio2 = () => {
    botonRappiRef.current.classList.add("border-4");
    botonRappiRef.current.classList.add("border-red-700");
    botonPeyaRef.current.classList.remove("border-red-700");
    botonPeyaRef.current.classList.remove("border-4");
    botonRappiRef.current.classList.remove(
      "hover:shadow-[0px_2px_17px_-5px_rgba(0,0,0,0.75)]"
    );
    botonPeyaRef.current.classList.add(
      "hover:shadow-[0px_2px_17px_-5px_rgba(0,0,0,0.75)]"
    );
  };
        ...
        <div className="py-8 bg-white w-12/12 md:w-4/12 md:rounded-2xl md:ml-16">
          ...
          <div className="flex w-11/12 gap-2 m-auto md:w-10/12">
            <div
              ...
              ref={botonPeyaRef}
              className="w-6/12 h-20 px-10 py-4 box-border md:w-10/12 rounded-xl cursor-pointer shadow-[0px_1px_8px_-3px_rgba(0,0,0,0.5)]  flex flex-col justify-center border-4 border-red-700"
            >
              <img
            ...
            <div
              ...
              ref={botonRappiRef}
              className="w-6/12 px-10 h-20 py-4 box-border md:w-10/12 rounded-xl cursor-pointer shadow-[0px_1px_8px_-3px_rgba(0,0,0,0.5)] hover:shadow-[0px_2px_17px_-5px_rgba(0,0,0,0.75)] flex flex-col justify-center"
            >
              <img
                className="w-5/12 m-auto"
